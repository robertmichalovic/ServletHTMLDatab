/*	Do prohlizece zadame :	http://localhost:8080/ProgramWeb/hlavni
 */
package servlet;
import java.io.*;
...
import www.html.*;
@WebServlet		//	@WebServlet("/HlavniStranka")
public class Hlavni extends HttpServlet implements PomocneRozhrani {
	private static final long serialVersionUID = 1L;
	private Body body;
	private Head head;
	private Html html;
	private String jmenoServletu;
    public String getJmenoServletu() {
		return jmenoServletu;	}
	public void setJmenoServletu(String jmenoServletu) {
		this.jmenoServletu = jmenoServletu;	}
	public Hlavni() {
        super();	}
    // zdedene od GenericServlet
    public void init() throws ServletException {
    	setJmenoServletu(getClass().getName());
    	html = new Html();
    	body = new Body(this);
    	head = new Head();	}
    // zdedene od GenericServlet
